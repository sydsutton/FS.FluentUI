...
type [<Erase>] ILineChartStylesProp = interface end
type [<Erase>] IEventsAnnotationProp = interface end
...
type [<Erase>] ISparklineStylesProp = interface end
...
type [<Erase>] IAnnotationProp = interface end
type [<Erase>] IChartAnnotationAccessibilityProp = interface end
type [<Erase>] IChartAnnotationConnectorProp = interface end
type [<Erase>] IChartAnnotationCoordinateProp = interface end
type [<Erase>] IChartAnnotationLayoutProp = interface end
type [<Erase>] IChartAnnotationStyleProp = interface end
type [<Erase>] IPolarChartProp = interface end
type [<Erase>] IAreaPolarSeriesProp = interface end
type [<Erase>] IDataSeriesProp = interface end
type [<Erase>] IPolarDataPointProp = interface end
type [<Erase>] ILinePolarSeriesProp = interface end
type [<Erase>] IScatterPolarSeriesProp = interface end
