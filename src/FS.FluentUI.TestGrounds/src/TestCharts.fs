...
open System
open FS.Charts.horizontalBarChart
open FS.Charts.verticalStackedBarChart
open Feliz
open FS.FluentUI
open FS.Charts
...
let areaChartDataList: LineChartData list = [
    {
        Name = "Areachart legend"
        Opacity = 1.0
        Color = "green"
        Data = [
            { x = 20.0; y = -9.0 }
                    ...
                    Html.div [
                        ...
                        prop.children [
                            ...
                            Charts.areaChart [
                                ...
                                // legendProps.legends [
                                //     Charts.legend [
                                //         legend.title "AreaChart legend1.1"
                                //         legend.color "red"
                                //         legend.shape.pentagon
                                //     ]
                                //     Charts.legend [
                                //         legend.title "Areachart legend" // Match this title with the lineChartData.legend field if want control of dataset
                                //         legend.color "blue"
                                //
                                //         legend.shape.circle
                                //         legend.isLineLegendInBarChart true
                                //         legend.onMouseOutAction (fun _ -> printfn "Exit")
                                //         legend.hoverAction (fun _ -> printfn "Enter")
                                //         legend.action (fun _ -> printfn "Click action")
                                //     ]
                                // ]
                                ]
                                areaChart.styles [ areaChart.styles.href "https://vg.no..." ]
                                areaChart.mode.tonexty
                                areaChart.enableGradient true
                                areaChart.data [
                                    chartProps.chartTitle "Areachart"
                                    chartProps.lineChartData [
                                        yield!
                                            areaChartDataList
                                            |> List.map (fun d ->
                                                Charts.lineChartData [
                                                    lineChartData.legendShape.diamond
                                                    lineChartData.color d.Color
                                                    lineChartData.legend d.Name
                                                    lineChartData.data [
                                                        yield!
