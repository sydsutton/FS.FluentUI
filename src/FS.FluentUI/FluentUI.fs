...
//---------------------------------------------------------------- Functions --------------------------------------------------------------------------------
    ...
    /// This function can take up to **10 class names** as arguments. `mergeClasses` joins classes together and deduplicates atomic declarations generated by `makeStyles()`. Handles scoped directional styles.
    ///
    /// **NOTE: If using conditional classNames, wrap the condition in parenthesis**.
    ///
    /// ie- `prop.className (Fui.mergeClasses [ styles.backgroundColor; (if isYellow then styles.yellowText else ""); "testSize" ])`
    static member inline mergeClasses (classNames: string list): string =
        ...
        | _ -> printfn $"You tried merging {classNames.Length} classNames. Please merge 10 classNames or less."; ""
